...
private:
  ...
  //uint64_t         m_firstFacePosx;          ///< x of position of the first visited hop along face [need to terminate recovery]
  //uint64_t         m_firstFacePosy;          ///< y of position of previous hop
