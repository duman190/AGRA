...
Ipv4Address PositionTable::ElectrostaticBestNeighbor(Vector position,
	...
	Vector holeC(300,450,0);//(375, 325, 0); // be aware these values are hardcoded for particular experiment
	double holeR = std::sqrt(2)*200;//388.909; // be aware these values are hardcoded for particular experiment
